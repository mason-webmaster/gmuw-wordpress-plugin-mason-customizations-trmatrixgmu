...
function gmuw_trmatrixgmu_display_matrix_search_form(){
    ...
    //Set SQL strings
        $mystatesql = "SELECT DISTINCT SZBTATC_SBGI_STAT_CODE FROM " . $mytable . " WHERE SZBTATC_SBGI_STAT_CODE IS NOT NULL AND SZBTATC_SBGI_STAT_CODE<>'' AND SZBTATC_SBGI_STAT_CODE NOT IN ('ab','on','cz') ORDER BY SZBTATC_SBGI_STAT_CODE;";
